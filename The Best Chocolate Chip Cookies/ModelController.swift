...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    func viewControllerAtIndex(index: Int, storyboard: UIStoryboard) -> DataViewController? {
        ...
        //dataViewController.imageObject = string(index)
